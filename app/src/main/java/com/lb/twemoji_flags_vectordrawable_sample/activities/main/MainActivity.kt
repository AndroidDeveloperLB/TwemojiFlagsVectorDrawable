...
import com.lb.twemoji_flags_vectordrawable_sample.activities.test_emoji.TestEmojiActivity
...
class MainActivity  : BoundActivity<ActivityMainBinding>(ActivityMainBinding::inflate) {
    ...
    private var allCountries: List<CountryAdapter.Country> = emptyList()
        ...
        addMenuProvider(object : MenuProvider {
            override fun onCreateMenu(menu: Menu, menuInflater: MenuInflater) {
                ...
                menu.addSubMenu("More info").let { subMenu ->
                    subMenu.setIcon(R.drawable.ic_menu_info_details)

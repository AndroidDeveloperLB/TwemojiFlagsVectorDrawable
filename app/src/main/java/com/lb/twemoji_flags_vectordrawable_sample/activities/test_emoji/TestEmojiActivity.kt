package com.lb.twemoji_flags_vectordrawable_sample.activities.test_emoji
...
import com.lb.twemoji_flags_vectordrawable_sample.activities.main.CountryRepository
...
class TestEmojiActivity :
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge(statusBarStyle = SystemBarStyle.Companion.dark(0))
